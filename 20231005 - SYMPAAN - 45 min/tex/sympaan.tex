...
\begin{frame}{Where have I been?}
    \begin{itemize}
        \vspace{-2cm}
        \onslide<1-> \item 06/2008 - 07/2011 : Bachelor degree, University of Turin.
        \onslide<2-> \item 09/2011 - 07/2013 : ALGANT Master, double degree, Padova-Leiden.
        \visible<2>{\begin{center}\includegraphics[height=4cm]{fig_Padova.jpg}\includegraphics[height=4cm]{fig_Leiden.jpg}\end{center}}
        \vspace{-4.4cm}
        \onslide<3-> \item 08/2013 - 07/2018 : PhD, Stockholm University.
        \visible<3>{\begin{center}\includegraphics[height=5cm]{fig_SU.jpg}\end{center}}
        \vspace{-5.4cm}
        \onslide<4-> \item 09/2018 - 12/2018 : Postdoc, Max Planck Institute, Bonn.
        \visible<4>{\begin{center}\includegraphics[height=5cm]{fig_Bonn.jpg}\end{center}}
        \vspace{-5.4cm}
        \onslide<5-> \item 01/2019 - 12/2020 : Postdoc, Utrecht University.
        \onslide<6->{\item 01/2021 - 12/2023 : Veni Postdoc, Utrecht University.}
        \visible<5-6>{\begin{center}\includegraphics[height=4cm]{fig_UU.jpg}\end{center}}
        \vspace{-4.4cm}
        \onslide<7-> \item 01/2024 - 12/2024 : Postdoc (with MELODIA) - Gaati Lab - Tahiti 
    \end{itemize}
\end{frame}
...
% \pause    
%     \item Now let's use this equivalence $\cC_h \longleftrightarrow$ fr.~ideals to prove something.
    \end{itemize}
\end{frame}
