...
%	\end{table}
%\pause
%    Among the $45$ isogeny classes which we cannot 'handle' with Thm 1 ($S^*_\R\subseteq T^*_\R$), we can compute the number of PPAV for $32$ of them using other methods. For the remaining $13$ (all over $\F_2$ and $\F_3$) we only get partial info.  
%\end{frame}
